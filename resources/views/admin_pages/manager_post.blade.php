...
<div class="father">
    ...
    <a class="son " href="{{route('quan-ly-bai-dang')}}" style="color:black">Bài đăng </a>
        ...
        <div class="rounded-2 d-flex p-4 pt-3 pb-3 mt-2 mb-3 justify-content-between  shadow-sm" style="background-color:white">
            <div class="d-flex flex-fill align-items-center">
                ...
                <div style="margin-left:3%">
                    <div class="fs-5 fw-semibold" style="width:500px">Tên: {{$item->nguoiDung->ho_ten}}</div>
                    <div style="width:500px" class=" fw-semibold">Tiêu đề bài đăng: {{$item->tieu_de}}</div>
                    <div style="width:500px" class=" fw-semibold">Nội dung bài đăng: {{$item->noi_dung}}</div>
                </div>
            </div>
