...
<div style="" class="mb-4">
    <div class="rounded p-5 pt-3 pb-3 shadow-sm mt-3" style="background-color: white">
        <div class="fs-3 fw-semibold text-center">Đăng bài admin</div>
        <hr>
            ...
            <div class="dandev-reviews">
                <label class="dandev_insert_attach rounded-2">
                    <span class=" d-inline-flex align-items-center">
                        ...
                        <div class="fw-semibold p-2 pt-0 pb-0 rounded shadow-sm" style="background-color: #052147;color:white">
                            + Thêm ảnh</div>
                    </span>
