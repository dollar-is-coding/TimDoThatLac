...
@section('main_admin')
    <div style="width:100%" class="d-flex justify-content-center">
        <div style="background-color: white;width:70%" class="mt-3 rounded shadow-sm">
            <h3 class="text-center mt-3">Đăng ký</h3>
            <hr>
            <form action="{{ route('xl-dang-ky-admin') }}" method="post" class="p-4 pt-0">
                @csrf
                <div class="m-2">
                ...
                <div class="d-flex justify-content-center mt-4"><button type="submit" class="btn btn-success">Đăng
                        ký</button>
                </div>
            </form>
        </div>
