...
@section('body')
    ...
    <div>
        <div class="d-flex flex-row justify-content-between align-items-center shadow-sm"
            style="padding:0.2em;padding-left:2em;padding-right:2em;background-color:white;">
            <div>
                <a href="">
        ...
        <div class="father">
            <div class="son1 border">
                ...
                <a href="{{ route('trang-chu-admin') }}" class="ah border" style="text-decoration: none;color:black;">Trang
                    chủ</a>
                <a href="{{ route('report-account') }}" class="ah border" style="text-decoration: none;color:black;">Báo
                    cáo</a>
                <a href="{{ route('quan-ly-tai-khoan') }}" class="ah border" style="text-decoration: none;color:black;">Quản
                    lý</a>
