...
@section('main')
    <<<<<<< HEAD <style>
        ...
        <style>
            ...
            >>>>>>>18cb146537bcbd8866bc669a10d8ab2b97aa2842 .box-full-zoom article {
                width: 100%;
                height: 80%;
                margin: 0 auto;
                margin-top: 5%;
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    @else
                                        <li><a class="dropdown-item"
                                                href="{{ Auth::id() == null ? '/dang-nhap' : '' }}">Theo
                                                dõi</a>
                                        </li>
                    ...
                    <<<<<<< HEAD @if (Auth::id() != null)
                        ...
                        @if (Auth::id() != null)
                            <div class="input-group hienthi">
                                <input class=" form-control rounded-5" type="text" name=""
                                    class="form-control" placeholder="Bình luận ...">&ensp;
                                <div class="rounded-3" style="padding-left:10px">
                                    <button class="btn btn-outline-primary" type="submit" id="button-addon2"> <img
                                            src="{{ URL('images/send.png') }}" style="width:1.45em;"> </button>
                                </div>
                                >>>>>>> 18cb146537bcbd8866bc669a10d8ab2b97aa2842
                            </div>
                </div>
            @endsection
